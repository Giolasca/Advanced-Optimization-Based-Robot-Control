import numpy as np
import orc.A3.DoublePendulum.MM_ocp_double_pendulum_conf as conf
import matplotlib.pyplot as plt
import matplotlib.animation as animation
import pandas as pd

# Load data from CSV
data = pd.read_csv("datamat.csv")

# Filter data based on the 'viable' column
viable_states = data[data['viable'] == 1][['q1', 'v1', 'q2', 'v2']].values
non_viable_states = data[data['viable'] == 0][['q1', 'v1', 'q2', 'v2']].values
