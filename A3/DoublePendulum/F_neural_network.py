...
if __name__ == "__main__":
    ...
    history = model.fit(train_data, train_label, epochs=100, validation_data=(test_data, test_label), callbacks=[early_stopping])
    ...
    model.save_weights("double_pendulum_v2.h5")
