...
if __name__ == "__main__":
    ...
    # Load existing points from a dataset to simplify the computational load
    if (conf.old_data == 1):
    
        # Load data from CSV
        # data = pd.read_csv("data_double_136475.csv")
        data = pd.read_csv("data_double_171780.csv")
    ...
    if (conf.multiproc == 1):
        if (conf.old_data == 1):
            ...
            print("Multiprocessing execution started, number of processes:", conf.num_processes, "number of points", state_array.shape)
    ...
    # Single process execution
        ...
        if (conf.old_data == 1):
            print("Single process execution started, number of points", new_state_array.shape)
        else:
            print("Single process execution started, number of points", state_array.shape)
