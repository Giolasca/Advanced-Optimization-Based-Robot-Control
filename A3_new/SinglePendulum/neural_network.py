...
if __name__ == "__main__":
    ...
    history = model.fit(train_data, train_label, epochs=200, validation_data=(test_data, test_label))
    ...
    model.save_weights("single_pendulum_funziona_1.h5")
