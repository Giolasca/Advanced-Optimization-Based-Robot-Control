...
for test_number in range(1, num_tests + 1):
    ...
    axs[0].plot(q2_NTC, label='Position_q2 (NTC) - N={}'.format(N_NTC), color='#ffa500', linewidth=2)  # NTC - q2
    axs[0].plot(q2_TC, label='Position_q2 (TC) - N={}'.format(N_TC), color='#1e90ff', linestyle='--', linewidth=2)  # TC - q2
    ...
    axs[1].plot(v2_NTC, label='Velocity_v2 (NTC) - N={}'.format(N_NTC), color='#ffa500', linewidth=2)  # NTC - v2
    axs[1].plot(v2_TC, label='Velocity_v2 (TC) - N={}'.format(N_TC), color='#1e90ff', linestyle='--', linewidth=2)  # TC - v2
    ...
    axs[2].plot(u2_NTC, label='Input_u2 (NTC) - N={}'.format(N_NTC), color='#ffa500', linewidth=2)  # NTC - u2
    axs[2].plot(u2_TC, label='Input_u2 (TC) - N={}'.format(N_TC), color='#1e90ff', linestyle='--', linewidth=2)  # TC - u2
