...
if noise:
    base_path = 'Plots_&_Animations/Test_225_unconstr_tanh_test_{}/mpc_SP_TC_noise_225_unconstr_tanh_test_{}.csv'
else:
    base_path = 'Plots_&_Animations/Test_225_unconstr_tanh_test_{}/mpc_SP_TC_225_unconstr_tanh_test_{}.csv'
